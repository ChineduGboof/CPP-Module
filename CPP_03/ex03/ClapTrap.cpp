...
/*   Updated: 2023/04/22 19:57:51 by gboof            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << CYAN << "Default ClapTrap constructor called for " << _name << "!" << DEFAULT << std::endl;
}
...
ClapTrap::~ClapTrap()
{
    std::cout << CYAN << "Destructor called for ClapTrap " << _name << "!" << DEFAULT << std::endl;
}
